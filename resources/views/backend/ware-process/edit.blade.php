                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        {{Form::number('price',$process->price,['class'=>'form-control','placeholder' => 'Цена продажи'])}}
                                    </div>
                                    @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <p class="erros-text">{{ $message }}</p>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        {{Form::number('count',$process->count,['class'=>'form-control','placeholder' => 'Количество'])}}
                                    </div>
                                    @error('count')
                                        <span class="invalid-feedback" role="alert">
                                            <p class="erros-text">{{ $message }}</p>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        {{ Form::text('date', $process->date, ['class'=>'form-control','placeholder' => 'Дата продажи','id' => 'datepicker','autocomplete'=>'off']) }}
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        {{ Form::text('item_number', $process->item_number, ['class'=>'form-control','placeholder' => 'Номер партии товара']) }}
                                    </div>
                                    @error('item_number')
                                        <span class="invalid-feedback" role="alert">
                                            <p class="erros-text">{{ $message }}</p>
